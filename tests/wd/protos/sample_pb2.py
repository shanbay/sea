...
_MESSAGEOFTYPES_ENUM = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="B", index=1, number=1, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="C", index=2, number=2, options=None, type=None
        ),
    ],
...
_MESSAGEOFTYPES = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="str_repeated",
            full_name="tests.MessageOfTypes.str_repeated",
            index=18,
            number=19,
            type=9,
            cpp_type=9,
    ...
    enum_types=[_MESSAGEOFTYPES_ENUM,],
    options=None,
    is_extendable=False,
    syntax="proto3",
    extension_ranges=[],
...
_MESSAGEOFTYPES_NESTEDMAPENTRY.fields_by_name[
    "value"
].message_type = _MESSAGEOFTYPES_NESTEDTYPE
...
_MESSAGEOFTYPES.fields_by_name[
    "simpleMap"
].message_type = _MESSAGEOFTYPES_SIMPLEMAPENTRY
_MESSAGEOFTYPES.fields_by_name[
    "nestedMap"
].message_type = _MESSAGEOFTYPES_NESTEDMAPENTRY
...
_MESSAGEOFTYPES_SIMPLEMAPENTRY._options = _descriptor._ParseOptions(
    descriptor_pb2.MessageOptions(), _b("8\001")
)
_MESSAGEOFTYPES_NESTEDMAPENTRY.has_options = True
_MESSAGEOFTYPES_NESTEDMAPENTRY._options = _descriptor._ParseOptions(
    descriptor_pb2.MessageOptions(), _b("8\001")
)
