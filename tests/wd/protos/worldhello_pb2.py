...
_HELLOREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="name",
            full_name="worldhello.HelloRequest.name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_HELLOREPLY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="message",
            full_name="worldhello.HelloReply.message",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
try:
    ...
    generated only to ease transition from grpcio<0.15.0 to grpcio>=0.15.0"""
        ...
        method_implementations = {
            ("worldhello.Greeter", "SayHello"): face_utilities.unary_unary_inline(
                servicer.SayHello
            ),
            ("worldhello.Greeter", "SayHelloAgain"): face_utilities.unary_unary_inline(
                servicer.SayHelloAgain
            ),
        }
    ...
    generated only to ease transition from grpcio<0.15.0 to grpcio>=0.15.0"""
        ...
        return beta_implementations.dynamic_stub(
            channel, "worldhello.Greeter", cardinalities, options=stub_options
        )
